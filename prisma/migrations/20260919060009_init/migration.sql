...
CREATE TABLE "Profile" (
    ...
    "hasChildren" TEXT,
    "heightCm" INTEGER,
    "physicalStatus" TEXT NOT NULL DEFAULT 'NORMAL',
    "disabilityNote" TEXT,
...
CREATE TABLE "Nominee" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "Nominee_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "GrievanceTicket" (
    ...
    "acknowledgeBy" DATETIME NOT NULL,
    "resolveBy" DATETIME NOT NULL,
...
CREATE TABLE "ErasureLog" (
    ...
    "erasedAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP
);
